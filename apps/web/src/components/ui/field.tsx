...
export const Field = forwardRef<HTMLInputElement, FieldProps>(function Field(
  ...
  return (
    <div className={className}>
      ...
      >
        <label htmlFor={inputId} className="pointer-events-none absolute top-2 left-4 text-[11.5px] font-semibold tracking-[0.01em] text-muted">
          {label}
        </label>
        <input
          ref={ref}
        ...
        />
        {trailing && (
          <span className="mb-0.5 ml-2 shrink-0" onClick={(e) => e.stopPropagation()}>
            {trailing}
          </span>
        )}
      </div>
